<div class="row">
    ...
    <?= $this->Form->create(null, ['name'=>'Form', 'type' => 'post', 'url'=>['controller'=>'News-users', 'action'=>'create']]) ?>
    
    <div><p><?=$this->Form->submit('確定', ['class'=>'btn btn-primary']) ?></p></div>
    <?= $this->Form->end() ?>
    <p><?= $this->Html->link('戻る', ['controller' => 'News-users', 'action' => 'add'],['class'=>'btn btn-danger']) ?></p>
